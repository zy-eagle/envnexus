...
VALUES ('01JTENANT0001DEFAULTADMIN00', 'Default Tenant', 'default', 'active', NOW(3), NOW(3));

INSERT INTO users (id, tenant_id, email, display_name, password_hash, status, created_at, updated_at)
VALUES ('01JUSER00001DEFAULTADMIN00', '01JTENANT0001DEFAULTADMIN00', 'admin@envnexus.local',
...
VALUES ('01JROLE00001TENANTADMIN000', '01JTENANT0001DEFAULTADMIN00', 'tenant_admin',
